...
lattice_sqrd = X.^2 + Y.^2; % norm squared of lattice
...
lattice_ksq = (2*pi)^2*((X/size_x).^2 + (Y/size_y).^2); % lattice of |k|^2 values
ksq = unique(lattice_ksq); % |k|^2 values sorted into vector