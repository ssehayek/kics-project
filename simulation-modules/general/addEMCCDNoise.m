...
% relative intensity value used for scaling autofluorescent background
rel_int_val = mean(J(:));
...
for ii = 1:2:length(varargin)
    ...
    elseif any(strcmpi(varargin{ii},{'relIntVal','relativeVal','relativeValue'}))
        rel_int_val = varargin{ii+1};
    end
end
...
J_autofluor = addLaserProfile(rel_int_val*autofluor_percent*ones(size(J)),laser_varargin{:});
